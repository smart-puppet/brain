...
class PhraseTtsPipeline:
  ...
  def __init__(
    ...
    tts: TtsBackend,
    *,
    play_chunk: Callable[[str, TtsChunk], None],
    ...
    self._audio_queue: queue.Queue[tuple[str, TtsChunk | object]] = queue.Queue()
    ...
    self._play_phrase: str | None = None
    self._paused = False
