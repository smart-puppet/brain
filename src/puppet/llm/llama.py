...
_TERNARY_HINT = (
  ...
  "Run: PRISM_LLAMA_ROOT=../PrismML-Eng/Jun12-2026 ./scripts/build_llama_prism.sh "
...
def create_llm(config: dict[str, Any]) -> LlmBackend:
  ...
  if backend == "llama_server":
    from puppet.llm.llama_server import create_llama_server

    return create_llama_server(config)
  if backend != "llama":
